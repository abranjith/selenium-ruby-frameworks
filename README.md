...
gmail_unread_message_count_capybara
====================================
This program reads unread message count from Inbox folder of gmail and prints the count on console

Before run:
1) capybara gem is installed
2) Make sure Firefox is installed. Feel free to use different browsers
3) Change username and password in the program to your own

Run (from command prompt):
ruby gmail_unread_message_count_capybara.rb
